...
const Education = () => {
  return (
    <div name="Education" className="bg-gray-800 pt-16">
      <div className="max-w-screen-lg mx-auto p-4 flex flex-col justify-center w-full h-full text-white ">
        ...
        <div>
          <ol className="relative border-s border-gray-200 dark:border-gray-700 text-white mx-2">
          <li className="mb-10 ms-6">
            ...
            <li className="mb-10 ms-6">
              ...
              <time className="block mb-2 text-sm font-normal leading-none text-gray-400 dark:text-gray-500">
                <p className="mb-2">Ahmedabad,Gujarat.</p>{" "}
                <p> Higher Secondary Education : 2019-2021</p>
              </time>
            ...
            <li className="ms-6">
              ...
              <time className="block mb-2 text-sm font-normal leading-none text-gray-400 dark:text-gray-500">
                <p className="mb-2">Ahmedabad,Gujarat.</p>{" "}
                <p> Secondary Education : 2017-2019</p>
              </time>
              <div className="text-base font-normal text-gray-200 ">
                <p>
                  Completed secondary education with a strong foundation in
                  science and mathematics, cultivating a passion for learning
