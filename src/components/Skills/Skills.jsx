...
const Skills = () => {
  return (
    ...
    <div>
    <p className='text-4xl font-bold p-2 border-b-4 border-gray-500 inline'>Skills</p>
    <p className='py-6 text-gray-300'>These are the technologies I've learned and worked with , </p>
</div>
   
<div className="grid grid-cols-2 w-full sm:grid-cols-3 gap-8 text-center py-8 px-12 sm:px-0  text-white">
